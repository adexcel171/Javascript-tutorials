...
In summary, var is function-scoped and has some quirks due to hoisting, let is block-scoped and allows for variable reassignment,
 and const is also block-scoped but prevents variable reassignment after the initial assignment. Choosing the appropriate type depends on your specific use case and the scope of the variable in your code. 
